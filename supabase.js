...
export async function registerCheckIn(userId) {
    try {
        console.log('Registrando entrada para usuario:', userId);
        
        // Primero verificar si ya tiene un registro activo hoy
        ...
        // Si ya tiene un registro activo, no crear otro
        if (existingRecord && !checkError) {
            throw new Error('Ya tienes una entrada registrada hoy');
        }
        
        // Crear nuevo registro
        const checkInTime = new Date().toISOString();
        console.log('Hora de entrada:', checkInTime);
        ...
        console.error('Error completo en registerCheckIn:', error);
        throw error;
    }
}
